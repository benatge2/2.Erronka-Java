...
public class bezeroak extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					bezeroak frame = new bezeroak(true);
	...
	public bezeroak(boolean admin) {
		...
		SQLResult = tablas.tabla.actualizartabla("bezeroak", table);
		...
		btnBilatu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SQLResult = tablas.tabla.actualizartabla("bezeroak",table,String.valueOf(txtColumna.getText()),String.valueOf(txtValor.getText()));
			}
		});
		...
		if(admin) {
			...
			btnUpdate.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					System.out.println("Update");
						tablas.modify.update("bezeroak", txtColumna.getText(), "NAN", txtID.getText(),
								TFInsert.getText());
			...
			btnEzabatu.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					tablas.modify.delete("bezeroak", "NAN", txtID.getText());
					SQLResult = tablas.tabla.actualizartabla("bezeroak", table);
				}
			});
		}
